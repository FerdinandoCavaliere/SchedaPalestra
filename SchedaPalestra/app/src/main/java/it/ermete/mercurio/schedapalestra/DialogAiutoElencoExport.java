...
public class DialogAiutoElencoExport extends DialogFragment {

    public static DialogAiutoElencoExport getInstance() {

        return new DialogAiutoElencoExport();
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View aiuto = inflaterAiuto.inflate(R.layout.dialog_guida_elenco_export, null);
