...
public class DialogAiutoStoricoSchede extends DialogFragment {

    public static DialogAiutoStoricoSchede getInstance() {

        return new DialogAiutoStoricoSchede();
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View aiuto = inflaterAiuto.inflate(R.layout.dialog_guida_storico_schede, null);
